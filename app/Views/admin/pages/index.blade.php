                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a class="btn btn-transparent btn-success btn-circle btn-sm active" href="{{ asset($adminCpAccess.'/pages/edit/0/'.$defaultLanguageId) }}"><i class="fa fa-plus"></i> Create</a>
                        </div>
                    </div>
                </div>
