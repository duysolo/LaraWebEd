                    ...
                    "ajax": { // define ajax settings
                        ...
                        "dataSrc": function(res) { // Manipulate the data returned from the server
                            if (res.customActionMessage) {
                                Utility.showNotification(res.customActionMessage, res.customActionStatus);
                            }
                        ...
                        "error": function() { // handle general connection errors
                            ...
                            Utility.showNotification(tableOptions.dataTableParams.language.metronicAjaxRequestGeneralError, 'danger');
